...
use src\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \src\Attribute|null */
    protected $attribute;

    /** @var \src\Validation|null */
     ...
     *
     * @param \src\Validation $validation
     * @return void
     */
     ...
     * @param array $params
     * @return void
     * @throws \src\MissingRequiredParameterException
     */
