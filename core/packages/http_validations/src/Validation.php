...
require_once __DIR__ . '/Traits/MessagesTrait.php';
require_once __DIR__ . '/Rule.php';
require_once __DIR__ . '/ErrorBag.php';
require_once __DIR__ . '/Attribute.php';
require_once __DIR__ . '/Helper.php';
require_once __DIR__ . '/MissingRequiredParameterException.php';
require_once __DIR__ . '/RuleNotFoundException.php';
require_once __DIR__ . '/RuleQuashException.php';
...
class Validation
{
    ...
    protected function parseRule(string $rule): array
    {
        $exp = explode(':', $rule, 2);
        $rulename = $exp[0];
        if ($rulename !== 'regex' && $rulename !== 'unique') {
